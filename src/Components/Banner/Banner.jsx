...
function Banner() {
    ...
    return (
        <div id='HOME' className={`h-[100vh] w-[100vw] bg-black flex flex-col-reverse md:flex-row items-center justify-center ${b['mobile-flex']}`}>
            <div ref={ref} className={`slide-in-left ${inView ? 'visible' : ''} w-[80vw] md:w-[30vw] p-4 flex flex-col items-center justify-center gap-5 ${b['text-container']}`}>
            ...
            <div ref={ref} className={`slide-in-left ${inView ? 'visible' : ''} rounded-3xl flex justify-center items-center md:justify-start`}>
